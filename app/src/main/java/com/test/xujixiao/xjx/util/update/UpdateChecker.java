...
public class UpdateChecker extends Fragment {
    ...
    /**
     * Show a Dialog if an update is available for download. Callable in a FragmentActivity. Number of checks after the dialog will be shown: default, 5
     *
    ...
    /**
     * Show a Notification if an update is available for download. Callable in a FragmentActivity Specify the number of checks after the notification will be shown.
     *
     * @param fragmentActivity Required.
     */
...
//        noti = new NotificationCompat.Builder(mContext).setTicker(getString(R.string.newUpdateAvailable)).setContentTitle(getString(
//                R.string.newUpdateAvailable)).setContentText(content).setSmallIcon(smallIcon).setContentIntent(pendingIntent).build();
