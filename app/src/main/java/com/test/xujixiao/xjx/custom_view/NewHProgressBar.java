 ...
 * xujixiao
 */
public class NewHProgressBar extends View {
    ...
    public NewHProgressBar(Context context) {
        super(context);
        init();
    }

    public NewHProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NewHProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        ...
        textPaint = new Paint();
        textPaint.setColor(getResources().getColor(R.color.gray_666666));
    ...
    private void changeMeasure() {
        ...
        paddingLeft = paddingRight = DisplayUtil.dip2px(getContext(), 16F);
    ...
    private void drawLine(Canvas canvas) {
        ...
        switch (workState) {
            case 1:
//                tempColor = getResources().getColor(R.color.status_zombie);
                break;
            case 2:
//                tempColor = getResources().getColor(R.color.status_loon);
                break;
            case 3:
//                tempColor = getResources().getColor(R.color.status_general);
                break;
            case 4:
//                tempColor = getResources().getColor(R.color.status_excellent);
                break;
            case 5:
